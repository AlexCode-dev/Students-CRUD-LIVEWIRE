...
class StudentShow extends Component
{
    ...
    public function updateStudent()
    {
        ...
        session()->flash('message','Student Updated Successfully'); //El método flash es una función de Laravel que permite almacenar información en la sesión de manera temporal para su uso en la siguiente solicitud.
